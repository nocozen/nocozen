<template>
  <div ref="this$refsLayout" class="vue-grid-layout" :style="mergeStyle">
    <slot></slot>
    <GridItem v-show="isDragging" ref="defaultGridItem" class="vue-grid-placeholder" :padding="padding" :x="placeholder.x"
      :y="placeholder.y" :w="placeholder.w" :h="placeholder.h" :i="placeholder.i" :isResizable="false"></GridItem>
  </div>
</template>
<script lang="ts">
export default {
...
import { toRaw, ref, onMounted, onBeforeUnmount, provide, onBeforeMount, nextTick, watch } from "vue"
...
const newColNum = ref(props.colNum);
provide('newColNum', newColNum);
