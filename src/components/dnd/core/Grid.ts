export default class Grid {
    ...
    constructor (collection: any, upToIndex: number, direction: string, fromIndex: number | null) {
     ...
     */
    center (rect: { left: number; width: number; top: number; height: number; }) {
      return {
     ...
     */
    before (rect: { left: number; top: number; height: number; width: number; }, horizontal: boolean) {
      return horizontal ? {
        x: rect.left,
        y: rect.top + rect.height / 2
      } : {
     ...
     */
    after (rect: { left: number; width: number; top: number; height: number; }, horizontal: any) {
      return horizontal ? {
