...
const naiveMenus = computed(() => {
  return routeStore.menus.find(menu => menu.key == 'backend')?.children || []
...
function handleClickMenu(key: RouteKey) {
  routerPushByKey(key, { query: route.query as any });
}
...
:deep(.n-menu .n-menu-item-content .n-menu-item-content__icon .iconify--carbon) {
